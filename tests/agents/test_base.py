...
class TestBaseAgent:
    ...
    async def test_agent_run_with_error(self):
        ...
        agent = TestAgent("test_agent", error=True)
...
class TestAgentPipeline:
    ...
    async def test_pipeline_with_error(self):
        ...
        agent1 = TestAgent("agent1")
        agent2 = TestAgent("agent2", error=True)
        agent3 = TestAgent("agent3")  # This agent should not be called
...
class TestParallelAgents:
    ...
    async def test_parallel_with_delays(self):
        ...
        agent1 = TestAgent("agent1", delay=0.1)
        agent2 = TestAgent("agent2", delay=0.2)
